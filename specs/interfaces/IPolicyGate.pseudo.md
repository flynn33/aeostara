...
Decides whether a completed RecoveryPlan may proceed under a PolicyBundle.

## Consumed Contract Types

`RecoveryPlan`, `PolicyBundle`

## Produced Contract Types

`PolicyDecision`, `DiagnosticReference`

## Operations

- `evaluate(plan: RecoveryPlan, bundle: PolicyBundle) -> PolicyDecision`
