...
Reads platform evidence and emits ObservedSystemState without fabricating missing state.
...
`ObservedSystemState`, `DiagnosticReference`

## Operations

- `observe(documentReference: JsonDocumentReference) -> ObservedSystemState`
