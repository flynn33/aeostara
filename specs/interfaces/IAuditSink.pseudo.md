...
Persists and retrieves ordered AuditEvent and AuditChain records without changing their meaning.
...
`AuditChain`, `DiagnosticReference`

## Operations

- `appendEvent(chain: AuditChain, event: AuditEvent) -> AuditChain`
- `persistChain(chain: AuditChain) -> DiagnosticReference`
- `readChain(auditChainID: string) -> AuditChain`
