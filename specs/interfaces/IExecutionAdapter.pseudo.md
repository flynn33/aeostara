...
Executes one approved RecoveryStep after all pre-execution gates pass.

## Consumed Contract Types

`ExecutionContext`, `RecoveryStep`

## Produced Contract Types

`ExecutionStepResult`, `DiagnosticReference`

## Operations

- `executeStep(context: ExecutionContext, step: RecoveryStep) -> ExecutionStepResult`
...
approved mutation only after policy, backup, and preconditions pass.
