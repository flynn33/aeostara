...
Applies approved JsonMutationOperation objects through downstream platform mechanics.

## Consumed Contract Types

`ExecutionContext`, `JsonMutationOperation`
...
- `applyMutation(context: ExecutionContext, operation: JsonMutationOperation) -> ExecutionStepResult`
