...
This active algorithm defines deterministic Aeostara base-design behavior for `containment_mode.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_containment_mode(input, lifecycleContext) -> contractOutput
