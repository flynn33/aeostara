...
This active algorithm defines deterministic Aeostara base-design behavior for `recovery_step_generation.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_recovery_step_generation(input, lifecycleContext) -> contractOutput
