...
This active algorithm defines deterministic Aeostara base-design behavior for `ash_diagnostic_evaluation.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_ash_diagnostic_evaluation(input, lifecycleContext) -> contractOutput
