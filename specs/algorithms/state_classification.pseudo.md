...
This active algorithm defines deterministic Aeostara base-design behavior for `state_classification.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_state_classification(input, lifecycleContext) -> contractOutput
