...
This active algorithm defines deterministic Aeostara base-design behavior for `realm_identity_binding.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_realm_identity_binding(input, lifecycleContext) -> contractOutput
