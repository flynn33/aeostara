...
This active algorithm defines deterministic Aeostara base-design behavior for `diagnostic_chain_integrity.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_diagnostic_chain_integrity(input, lifecycleContext) -> contractOutput
