...
This active algorithm defines deterministic Aeostara base-design behavior for `recovery_plan_deterministic_identity.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_recovery_plan_deterministic_identity(input, lifecycleContext) -> contractOutput
