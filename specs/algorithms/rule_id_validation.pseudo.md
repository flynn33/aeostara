...
This active algorithm defines deterministic Aeostara base-design behavior for `rule_id_validation.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_rule_id_validation(input, lifecycleContext) -> contractOutput
