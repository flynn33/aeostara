...
This active algorithm defines deterministic Aeostara base-design behavior for `fallback_selection.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_fallback_selection(input, lifecycleContext) -> contractOutput
