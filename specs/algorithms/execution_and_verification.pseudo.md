...
This active algorithm defines deterministic Aeostara base-design behavior for `execution_and_verification.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_execution_and_verification(input, lifecycleContext) -> contractOutput
