...
This active algorithm defines deterministic Aeostara base-design behavior for `rollback_lifecycle.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_rollback_lifecycle(input, lifecycleContext) -> contractOutput
