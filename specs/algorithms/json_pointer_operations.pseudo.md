...
This active algorithm defines deterministic Aeostara base-design behavior for `json_pointer_operations.pseudo.md`. Authority flows from the ASH Pattern System baseline through the frozen Aeostara contracts, ASH bindings, conformance fixtures, and lifecycle documents.
...
```text
FUNCTION run_json_pointer_operations(input, lifecycleContext) -> contractOutput
