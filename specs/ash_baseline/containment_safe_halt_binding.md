...
# Containment and Safe-Halt Binding

## Upstream ASH Source

- Baseline: `ASH Pattern System main@e123f5d7fdbb381179971f721a3292c31eb1cbc2`
- Source path: `specs/algorithms/containment-safe-failure-semantics.pseudo.md`

## Aeostara Binding Responsibility

Containment emits diagnostics and safe halt is terminal.

Aeostara records this binding through `ContainmentDecision.schema.json and SafeHaltDecision.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
