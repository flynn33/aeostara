...
# Canonical Codeword Set Binding

## Upstream ASH Source

- Baseline: `ASH Pattern System main@e123f5d7fdbb381179971f721a3292c31eb1cbc2`
- Source path: `specs/core/codeword-set.pseudo.md`

## Aeostara Binding Responsibility

Exactly the 16 canonical [9,4,4] codewords; no invented or runtime-selected codewords.

Aeostara records this binding through `CanonicalCodewordSet.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
