...
- Source path: `specs/core/state-admissibility.pseudo.md`

## Aeostara Binding Responsibility

VALID, TRANSFORMATION_COMPATIBLE, TRANSFORMATION_INCOMPATIBLE, and UNCLASSIFIED classification.

Aeostara records this binding through `AdmissibilityResult.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
