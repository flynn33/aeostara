...
# Recoverability Binding

## Upstream ASH Source

- Baseline: `ASH Pattern System main@e123f5d7fdbb381179971f721a3292c31eb1cbc2`
- Source path: `specs/core/recoverability-semantics.pseudo.md`

## Aeostara Binding Responsibility

Deterministic class-to-recovery-category mapping and monotonic blocked-path escalation.

Aeostara records this binding through `RecoveryCategory.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
