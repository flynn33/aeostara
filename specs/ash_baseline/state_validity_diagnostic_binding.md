...
# State Validity Diagnostic Binding

## Upstream ASH Source

- Baseline: `ASH Pattern System main@e123f5d7fdbb381179971f721a3292c31eb1cbc2`
- Source path: `specs/core/state-validity-diagnostics.pseudo.md`

## Aeostara Binding Responsibility

Explainable diagnostics for state validity, normalization, and recoverability relevance.

Aeostara records this binding through `StateValidityDiagnostic.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
