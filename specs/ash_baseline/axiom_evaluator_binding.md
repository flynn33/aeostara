...
# Axiom Evaluator Binding

## Upstream ASH Source

- Baseline: `ASH Pattern System main@e123f5d7fdbb381179971f721a3292c31eb1cbc2`
- Source path: `specs/algorithms/axiom-evaluation.pseudo.md`

## Aeostara Binding Responsibility

Every axiom evaluation returns explainable diagnostics rather than bare pass/fail.

Aeostara records this binding through `AxiomDiagnostic.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
