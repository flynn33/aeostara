...
# Topology Generator Binding

## Upstream ASH Source

- Baseline: `ASH Pattern System main@e123f5d7fdbb381179971f721a3292c31eb1cbc2`
- Source path: `specs/algorithms/topology-expansion.pseudo.md`

## Aeostara Binding Responsibility

Topology generation is deterministic with stable ordering, lineage, and diagnostics.

Aeostara records this binding through `TopologyPlan.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
