...
# ASH State Space Binding

## Upstream ASH Source

- Baseline: `ASH Pattern System main@e123f5d7fdbb381179971f721a3292c31eb1cbc2`
- Source path: `specs/core/ash-state-space.pseudo.md`

## Aeostara Binding Responsibility

F2^9 full 9-coordinate binary states; all coordinates participate in semantic projection.

Aeostara records this binding through `AshState.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
