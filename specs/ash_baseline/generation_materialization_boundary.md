...
- Source path: `specs/algorithms/generation-planning.pseudo.md and specs/interfaces/contracts/artifact-emitter-contract.md`

## Aeostara Binding Responsibility

Planning is side-effect-free; emission materializes only plan-defined artifacts and invents no semantics.

Aeostara records this binding through `GenerationPlan.schema.json and ArtifactEmissionPlan.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
