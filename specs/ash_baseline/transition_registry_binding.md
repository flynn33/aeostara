...
- Source path: `specs/algorithms/transition-system.pseudo.md`

## Aeostara Binding Responsibility

Transitions resolve deterministically and apply XOR-by-codeword over full states.

Aeostara records this binding through `TransitionDefinition.schema.json and TransitionResult.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
