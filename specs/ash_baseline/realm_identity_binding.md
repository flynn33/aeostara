...
- Source path: `specs/core/realm-identity.pseudo.md`

## Aeostara Binding Responsibility

Realm identity is deterministic from the full 9-bit state and rejects invalid states diagnostically.

Aeostara records this binding through `RealmIdentity.schema.json` and the associated algorithms, fixtures, and conformance checks. Aeostara must not redefine the upstream ASH semantics behind this binding.
